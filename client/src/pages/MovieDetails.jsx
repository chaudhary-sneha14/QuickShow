...
const MovieDetails = () => {
  ...
  return  show ?(
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <div className='flex items-center flex-wrap gap-4 mt-4'>
            ...
            <a href="#booknow" className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition
      ...
      <p className='text-lg fonnt-medium mt-20'>Your Favorite Cast</p>
      ...
      <div id='booknow'><DateSelect dateTime={show.dateTime} id={id}/> </div>
